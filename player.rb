...
if __FILE__ == $0 # or $PROGRAM_NAME
  ...
  player1 = PragStudioGame::Player.new( "neil", 60 )
  player2 = PragStudioGame::Player.new( "geddy", 125 )
  player3 = PragStudioGame::Player.new( "alex", 125 )
  ...
  puts PragStudioGame::Player::HIT_DAMAGE
  puts PragStudioGame::Playable::HIT_DAMAGE
